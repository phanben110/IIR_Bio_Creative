...
input_path = "./../Add_Relation/Entities-Identifiers_Relation-Run3.pubtator"
...
def replace_relation(input_path, dataset_path): 
    ...
    count = 0 
    if code a =timedelta A duration expressing the difference between two ()timedelta A duration expressing the difference between two ()this case
