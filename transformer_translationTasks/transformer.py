...
from tensorflow import data, train, math, reduce_sum, cast, equal, argmax, float32, GradientTape, function, shape
...
class LRScheduler(LearningRateSchedule):
    ...
    def __call__(self, step_num):
        step_num = cast(step_num, dtype=float32)
...
for epoch in range(epochs):
    ...
    for step, (train_batchX, train_batchY) in enumerate(train_dataset):
        ...
        # print(f'transformer - encoder_input {shape(encoder_input)}')
